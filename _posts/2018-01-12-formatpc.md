...
- After the pc restarted, the screen will jump straight to the bios. Which you will be able to change the boot order here. Change the boot order (make it to 1st Option in list) -> Your 8GB Pendrive
